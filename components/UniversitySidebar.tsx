...
export function UniversitySidebar() {
  ...
  const SidebarContent = () => (
    <div className="flex flex-col h-full bg-gradient-to-b from-slate-900 to-slate-950">
      ...
      <div className="p-4 sm:p-6 border-b border-slate-800">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-500/20">
              <GraduationCap className="w-5 h-5 sm:w-6 sm:h-6 text-white" />
            </div>
            <div>
              <h1 className="text-base sm:text-lg font-bold text-white">University Portal</h1>
      ...
      {/* Welcome Card */}
      <div className="p-4">
        <div className="bg-gradient-to-br from-blue-500/10 to-indigo-500/10 border border-blue-500/20 rounded-xl p-4 backdrop-blur-sm">
      ...
      <div className="p-4 border-t border-slate-800">
        <div className="bg-slate-800/30 rounded-xl p-3 border border-slate-700/50">
          ...
          <div className="space-y-2">
            <button className="w-full text-left text-xs text-slate-300 hover:text-white transition-colors py-1">
              📊 View Reports
            </button>
            <button className="w-full text-left text-xs text-slate-300 hover:text-white transition-colors py-1">
              📅 Academic Calendar
